...
return <>
    <header>
<nav className="navbar navbar-dark bg-dark navbar-expand-lg" aria-label="Global navigation - No title with nav-under example">
  <div className="container-xxl">
    <div className="navbar-brand me-auto me-lg-4">
      <a className="stretched-link" href="#">
        <img src="/public/orange-logo.svg" alt="Boosted - Back to Home" loading="lazy" width="50" height="50"/>
      </a> <h1 className="title">BPMN</h1>
    </div>
    <button className="navbar-toggler collapsed" type="button" data-bs-toggle="collapse" data-bs-target=".global-header-2" aria-controls="global-header-2.1 global-header-2.2" aria-expanded="false" aria-label="Toggle navigation">
      <span className="navbar-toggler-icon"></span>
    </button>
    <div id="global-header-2.1" className="navbar-collapse collapse me-lg-auto global-header-2">
    ...
    <form className="d-flex d-none d-lg-flex col-3 navbar-item" role="search">
      <input className="form-control bg-transparent text-white border border-2 border-dark" type="search" placeholder="Search" aria-label="Search" />
    </form>
    <div id="global-header-2.2" className="navbar-collapse collapse d-sm-flex global-header-2">
      <ul className="navbar-nav">
        <li className="nav-item"><a className="nav-link active" href="#" aria-label="EN English version" aria-current="true">EN</a></li>
        <li className="nav-item"><a className="nav-link" href="#" aria-label="FR Version française" hreflang="fr" lang="fr">FR</a></li>
    ...
    <main>
      <ReactBpmn
        url="/public/diagram.bpmn2" onShown={ onShown }
      ...
      <form className="needs-validation mb-5" novalidate="">
        ...
        <div className="row">
          ...
          <div className="col-sm-4 col-md-6 mb-3">
            <label for="selectTitle" id="selectTitleLabel" className="form-label is-required">Title<span className="visually-hidden"> (required)</span></label>
            <select className="form-select" id="selectTitle" aria-labelledby="selectTitleLabel selectTitleFeedback" autocomplete="sex" required="">
          ...
          <div className="col-12">
            <div className="mb-3">
              <label for="firstName" id="firstNameLabel" className="form-label is-required">First name<span className="visually-hidden"> (required)</span></label>
              <input type="text" className="form-control" id="firstName" aria-labelledby="firstNameLabel firstNameFeedback" autocomplete="given-name" required=""/>
              <div className="valid-feedback">
                Looks good!
              </div>
            ...
            <div className="mb-3">
              <label for="lastName" id="lastNameLabel" className="form-label is-required">Last name<span className="visually-hidden"> (required)</span></label>
              <input type="text" className="form-control" id="lastName" aria-labelledby="lastNameLabel lastNameFeedback" autocomplete="family-name" required=""/>
              <div className="valid-feedback">
                Looks good!
              </div>
            ...
            <div className="mb-3">
              <label for="email" id="emailLabel" className="form-label is-required">Email<span className="visually-hidden"> (required)</span></label>
              <input type="email" className="form-control" id="email" aria-labelledby="emailLabel emailFeedback" autocomplete="email" required=""/>
              <div className="valid-feedback">
                Looks good!
              </div>
            ...
            <div className="mb-3">
              <label for="country" id="countryLabel" className="form-label is-required">Country<span className="visually-hidden"> (required)</span></label>
              <select className="form-select" id="country" aria-labelledby="countryLabel countryFeedback" autocomplete="country-name" required="">
            ...
            <div className="mb-3">
              <label for="company" id="companyLabel" className="form-label is-required">Name of company<span className="visually-hidden"> (required)</span></label>
            ...
            <div className="mb-3">
              <label for="business" id="businessLabel" className="form-label is-required">Business type<span className="visually-hidden"> (required)</span></label>
            ...
            <div className="mb-3">
              <label for="website" id="websiteLabel" className="form-label">Website<span className="visually-hidden"> (required)</span></label>
            ...
            <div className="mb-3">
              <label for="message" id="messageLabel" className="form-label is-required">Message<span className="visually-hidden"> (required)</span></label>
  ...
  <div className="container-xxl footer-title-content">
    ...
    <div className="row">
      <form className="d-flex col-12 col-md-9 col-lg-7 col-xl-6 col-xxl-5 gap-2 gap-md-3">
        <label for="inputEmail5" className="visually-hidden">Email</label>
  ...
  <div className="container-xxl footer-service">
    <ul className="navbar-nav gap-3 gap-md-4">
      <li><a className="nav-link gap-1" href="#"><svg width="1.875rem" height="1.875rem" focusable="false" aria-hidden="true"><use xlink:href="../assets/img/boosted-sprite.svg#location-pin-compass"></use></svg><span>Store locator</span></a></li>
      <li><a className="nav-link gap-1" href="#"><svg width="1.875rem" height="1.875rem" focusable="false" aria-hidden="true"><use xlink:href="../assets/img/boosted-sprite.svg#mobile-network-coverage"></use></svg><span>Coverage checker</span></a></li>
      <li><a className="nav-link gap-1" href="#"><svg width="1.875rem" height="1.875rem" focusable="false" aria-hidden="true"><use xlink:href="../assets/img/boosted-sprite.svg#live-chat"></use></svg><span>Contact us</span></a></li>
      <li><a className="nav-link gap-1" href="#"><svg width="1.875rem" height="1.875rem" focusable="false" aria-hidden="true"><use xlink:href="../assets/img/boosted-sprite.svg#child-protection"></use></svg><span>Child protection</span></a></li>
    </ul>
  </div>
  <div className="border-bottom border-1 border-dark"></div>
